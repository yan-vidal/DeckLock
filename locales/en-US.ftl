...
unsupported = This desktop does not let other programs provide the lock screen. DeckLock needs a compositor with ext-session-lock-v1, such as Sway or Hyprland; GNOME and KDE Plasma are not supported.
...
auth-locked-in = Account locked by failed attempts. Estimated wait: %s.
